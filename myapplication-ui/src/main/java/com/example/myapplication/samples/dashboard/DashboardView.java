...
import com.example.myapplication.samples.dashboard.DashboardEdit.DashboardEditListener;
...
//        		MockDataGenerator.chartColors[0], 22, 20, 80);
//        sparks.addComponent(s);
//
//        s = new SparklineChart("Revenue / Day", "M", "$",
//        		MockDataGenerator.chartColors[2], 8, 89, 150);
//        sparks.addComponent(s);
//
//        s = new SparklineChart("Checkout Time", "s", "",
//                MockDataGenerator.chartColors[3], 10, 30, 120);
//        sparks.addComponent(s);
//
//        s = new SparklineChart("Theater Fill Rate", "%", "",
//        		MockDataGenerator.chartColors[5], 50, 34, 100);
//        sparks.addComponent(s);
//
//        return sparks;
//    }
...
//    }
    ...
    private Component buildTopGrossingMovies() {
    	TopPriceProductChart topPriceProductChart = new TopPriceProductChart();
    	topPriceProductChart.setSizeFull();
        return createContentWrapper(topPriceProductChart);
    }
